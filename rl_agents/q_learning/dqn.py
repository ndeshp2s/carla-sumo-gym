...
class DQNAgent:
    ...
    def compute_predicted_q(self, ego_vehicle_states, environment_states, actions):
        ...
        q_predicted = self.local_network(x1 = ego_vehicle_states, x2 = environment_states).gather(1, actions.long())
        return q_predicted
    ...
    def compute_predicted_q_next(self, ego_vehicle_next_states, environment_next_states):
        ...
        q_next_predicted = self.local_network(x1 = ego_vehicle_next_states, x2 = environment_next_states).gather(1, max_action_index.unsqueeze(1)) 
